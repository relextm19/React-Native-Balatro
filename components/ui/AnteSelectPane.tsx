...
export default function AnteSelectPane({
    ...
    return (
        ...
        <View className={`bg-darkBg w-2/6 h-full border-5 border-[#362602] rounded-main border-b-0 rounded-be-none rounded-bl-none p-2 ${blindState != BlindState.selected ? "opacity-50" : ""}`}>
